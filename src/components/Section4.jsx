    ...
    <div className="bg-orange-50 max-sm:bg-white py-16 flex justify-center ">
      <div className="max-w-5xl w-full flex flex-col md:flex-row items-center bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="md:w-1/2 p-4">
          <h2 className="text-lg font-semibold text-purple-700">Demos booked per month:</h2>
          <h1 className="text-3xl font-bold mb-4">from 0 to 50</h1>
          <p className="text-gray-700 mb-4">
            “The results with dofollow.com have been incredible. From organic traffic we went from booking zero demos
